...
public class UserController {
    ...
    @ApiOperation(value = "Create User", response = User.class, responseContainer = "User", code = 201)
    ...
    @ApiOperation(value = "Delete User by id", response = User.class, responseContainer = "User", code = 200)
    ...
    @ApiOperation(value = "Return User by Id", response = User.class, responseContainer = "User", code = 200)
    ...
    @ApiOperation(value = "Return all Users", response = User.class, responseContainer = "User", code = 200)
